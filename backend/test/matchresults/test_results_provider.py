...
from matchpredictor.matchresults.results_provider import load_results, load_csv_from_disk
...
class TestResultsProvider(TestCase):
    ...
    def test_loading_results_from_disk(self) -> None:

        results = load_results('spi_matches_sample', get_csv=load_csv_from_disk)
